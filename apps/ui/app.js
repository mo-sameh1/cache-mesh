...
function renderSettings() {
  ...
  $("#inference-stub").classList.toggle("active", state.settings.inferenceMode === "stub");
  $("#inference-real").classList.toggle("active", state.settings.inferenceMode === "real");
...
function wireEvents() {
  ...
  $("#inference-stub").addEventListener("click", () => {
    state.settings.inferenceMode = "stub";
    $("#model-id-input").value = "demo-model";
    saveSettings();
    renderSettings();
  });
  $("#inference-real").addEventListener("click", () => {
    state.settings.inferenceMode = "real";
    $("#model-id-input").value = "Qwen/Qwen2.5-7B-Instruct";
    saveSettings();
    renderSettings();
  });
